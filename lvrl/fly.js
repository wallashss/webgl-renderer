...
function Fly()
{
	...
	this.forwardDirection = vec3.fromValues(0.0, 0.0, -1.0);	
}

Fly.prototype = Object.create(Manipulator.prototype);

Fly.prototype.setFowardDirection = function(forward)
{
	this.forwardDirection = vec3.clone(forward);
}

Fly.prototype.updateView = function(dt, state)
{
	...
	let forward = vec3.clone(this.forwardDirection);
...
Fly.prototype.applyRestrictions = function(up)
{
	let invViewMatrix = mat4.create();
