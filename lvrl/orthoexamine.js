...
OrthoExamine.prototype.updateProjection = function(dt, state)
{
		...
		!glMatrix.equals(state.pan[1], 0.0))
	{
		...
		// let checkConstraint = true;

		let enableXConstraints = true;
		let enableYConstraints = true;
		...
		if(hasZoom)
		{
			...
			if(this.padding[0] > 0)
			{
				enableXConstraints = false;
			}

			if(this.padding[1] > 0)
			{
				enableYConstraints = false;
			}
		}
